...
class MongoDatabase {
  ...
  findNear(collectionName, geolocation, criteria, options) {
    var collection = this._mongoDb.collection(collectionName);
    return collection.geoNear(geolocation.longitude, geolocation.latitude, criteria, options).then(response => {
